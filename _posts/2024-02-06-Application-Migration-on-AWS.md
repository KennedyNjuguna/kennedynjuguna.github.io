...
After testing and the lifecycle indicates "ready for cutover" you are now ready to initaiate the cutover process. The testing instance is deleted and a working instance is now created.
